...
console.log(joe);
console.log("Arrow functions can never be used as constructor functions.Hence, they can never be invoked with the new keyword")
...
//undefined because this perfect for the whole window 
// 2. What is "this" when joe.scopeArrow() is invoked?
//this> here refers to the global window object
// 3. Explain why "this" is different when an arrow function is used.
//arrow functions retain the <this> value of the enclosing functional scope so we cant use it in constuctor functions
